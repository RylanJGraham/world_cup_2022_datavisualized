...
const MatchupMexicoArgentina = () => {
  ...
  const possessionData = {
    ...
    contested: 14, // Contested area percentage
  };
  ...
  const heatmapData = {
    ...
    team2Name: 'Mexico',
    leftChannel: { team1: 16, team2: 13 },
    centralChannel: { team1: 2, team2: 1 },
    rightChannel: { team1: 16, team2: 9 },
  };
...
export default MatchupMexicoArgentina;
